  ...
  return (
    <div className="w-[100%] flex border border-[#2C2C2C] bg-[#141414] rounded-lg relative max-sm:h-[52px]">
      ...
      {check && (
        <div
          onClick={onClick}
          className="w-[80px] h-[28px] bg-[#aaaaaaff] text-[16px] text-[#16171B)] px-3 py-[2px] text-center rounded-[32px] font-bold absolute right-[20px] top-[20px] cursor-pointer max-sm:top-[10px] max-sm:right-[10px]"
        >
          Check
        </div>
      )}
