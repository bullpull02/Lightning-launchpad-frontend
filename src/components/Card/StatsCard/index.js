...
const StatsCard = ({
  ...
  return (
    <div className="flex flex-col min-w-[335px] rounded-[10px] border border-[#2C2C2C] bg-[#000000ff] p-[30px] gap-y-[35px]">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-x-3 items-center">
          ...
          />
          <p className="text-[#aaaaaaff] text-[14px] max-sm:text-xs">
            {percent} %
          </p>
        </div>
      </div>
