...
const PresalesCard = ({
  ...
  return (
    ...
    >
      <div className="h-[470px] rounded-2xl bg-[#000000ff] overflow-hidden relative border border-[#2C2C2C]">
        ...
        <div className="pt-2 px-5 pb-5">
          ...
          <div className="flex flex-col gap-3 mt-6">
            <div className="flex justify-between items-center">
              ...
              <p className="text-[#aaaaaaff] text-[14px]">Percent Reward</p>
            </div>
            <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="text-[#aaaaaaff] text-[14px]">126K (16 stakers) </p>
            </div>
            <div className="flex justify-between items-center">
              <p className="text-white text-[14px]">Start Time :</p>
              <div className="flex flex-col w-[30%] h-[1px] border border-dashed border-[#2C2C2C]"></div>
              <p className="text-[#aaaaaaff] text-[14px]">2023-08-17 13:20</p>
            </div>
            <div className="flex justify-between items-center">
              <p className="text-white text-[14px]">End Time :</p>
              <div className="flex flex-col w-[30%] h-[1px] border border-dashed border-[#2C2C2C]"></div>
              <p className="text-[#aaaaaaff] text-[14px]">2024-08-17 13:20</p>
            </div>
          </div>
        </div>
      </div>
